  ...
  return (
    <footer style={{ background: '#030308', borderTop: '1px solid rgba(57,255,20,0.2)', marginTop: 'auto' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 24px 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32 }}>
        {/* Brand */}
        <div>
          <p className="neon-green font-pixel" style={{ fontSize: '0.7rem', marginBottom: 12 }}>👽 COSMIC BEAN</p>
          <p style={{ color: '#666', fontSize: '0.75rem', lineHeight: 1.7 }}>
            Fueling your adventures<br />across the galaxy,<br />one cup at a time.
          </p>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[['/', 'Home'], ['/menu', 'Menu'], ['/order', 'Order'], ['/gallery', 'Gallery'], ['/reviews', 'Reviews'], ['/location', 'Location']].map(([to, label]) => (
        ...
        {/* Contact */}
        <div>
          <p className="neon-blue font-pixel" style={{ fontSize: '0.55rem', marginBottom: 12, letterSpacing: '0.12em' }}>TRANSMIT</p>
          <div style={{ color: '#888', fontSize: '0.75rem', lineHeight: 2 }}>
            <p>📍 42 Nebula Ave, Unit 7</p>
            <p>🕐 Mon–Fri: 7am – 9pm</p>
            <p>🕐 Sat–Sun: 8am – 10pm</p>
            <p style={{ marginTop: 8 }}>📡 hello@cosmicbean.coffee</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '16px 24px', textAlign: 'center' }}>
        <p className="font-pixel" style={{ fontSize: '0.45rem', color: '#444', letterSpacing: '0.1em' }}>
          © 2025 COSMIC BEAN COFFEE · TRANSMITTING FROM SECTOR 7-G
        </p>
      </div>
    </footer>
  )
