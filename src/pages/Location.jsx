...
function InfoCard({ title, children, neonClass, borderClass }) {
  return (
    <div className={`comic-card ${borderClass}`} style={{ padding: '28px 24px' }}>
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, marginBottom: 40 }}>
        ...
        <InfoCard title="📍 ADDRESS" neonClass="neon-green" borderClass="border-neon-green">
        ...
        <InfoCard title="🕐 HOURS" neonClass="neon-purple" borderClass="border-neon-purple">
          ...
          <p style={{ color: '#666', fontSize: '0.72rem', marginTop: 16 }}>
            🛸 Last order 30 minutes before close
          </p>
        </InfoCard>

        <InfoCard title="📡 CONTACT" neonClass="neon-blue" borderClass="border-neon-blue">
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {[
              ['📞 Phone', '(713) 555-0042'],
